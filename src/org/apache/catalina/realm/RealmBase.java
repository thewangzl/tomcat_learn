...
public abstract class RealmBase implements Realm, Lifecycle {
	 ...
	 * MessageDigest class, or <code>null</code> if no digesting should be
	 * performed.
	 */
	...
	public Principal authenticate(String username, String clientDigest, String nOnce, String nc, String cnonce,
		 ...
		 * System.out.println("nOnce:" + nOnce); System.out.println("nc:" + nc);
		 * System.out.println("cnonce:" + cnonce); System.out.println("qop:" +
		 * qop); System.out.println("realm:" + realm);
	 ...
	 * synchronized because it reuses the MessageDigest instance. This should be
	 * faster than cloning the instance on every request.
	 *
	 * @param credentials
	 *            Password or other credentials to use in authenticating this
	 *            username
	...
	/**
	 * Digest password using the algorithm especificied and convert the result
	 * to a corresponding hex string. If exception, the plain credentials string
	 * is returned
	 *
	 * @param credentials
	 *            Password or other credentials to use in authenticating this
	 *            username
	 * @param algorithm
	 *            Algorithm used to do th digest
	 */
